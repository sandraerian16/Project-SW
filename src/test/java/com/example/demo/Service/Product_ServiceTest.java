...
public class Product_ServiceTest {
  ...
  /*  @Test
    public void testBuy_Product() throws Exception {
        ...
        Mockito.when( reprository.save(p)).thenReturn(p);
        assertEquals(service.Buy_Product(t,request),"NormalUserPage");
   ...
   /* @Test
    public void testViewStatistic() throws Exception {
        ...
        ArrayList<Store> arr = new ArrayList<>(); arr.add(store1);
        ...
        ArrayList<Product> sf = new ArrayList<>(); sf.add(p1); sf.add(p2);
