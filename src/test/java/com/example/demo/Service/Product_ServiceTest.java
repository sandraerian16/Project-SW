...
public class Product_ServiceTest {
    ...
    public void testAddProduct_ToStore_emptyinput() throws Exception {
        ...
        assertEquals(service.AddProduct_ToStore(model, p,request), "storeAddProduct");
    }
    ...
    public void testAddProduct_ToStore_existigProduct() throws Exception {
        ...
        assertEquals(service.AddProduct_ToStore(model, p,request), "storeOwner_page");
    }
    ...
    public void testEditProduct_ToStore_empty() throws Exception {
        Product p = new Product("", "", "", 0, 0, 0, 0);
        assertEquals(service.EditProduct_ToStore(model, p,request), "storeEditProduct");
    }
    ...
    public void testEditProduct_ToStore() throws Exception {
        ...
        Mockito.when(reprository.save(p)).thenReturn(p);
        Mockito.when(Actions_RB.save(A1)).thenReturn(A1);
        assertEquals(service.EditProduct_ToStore(model, p,request), "storeOwner_page");
    }
    ...
    public void testDeleteProduct_ToStore_empty() throws Exception {
        ...
        assertEquals(service.DeleteProduct_ToStore(model, p,request), "storeDeleteProduct");
    }
    ...
    public void testDeleteProduct_ToStore() throws Exception {
        ...
        Mockito.when(Actions_RB.save(A1)).thenReturn(A1);
        assertEquals(service.DeleteProduct_ToStore(model, p,request), "storeOwner_page");
    }
   @Test
    ...
    public void testUndoAction2_ADD() throws Exception {
        Actions A1 = new Actions("ADD", "name", "store1", "type", 10, 5);
        ...
        Mockito.when( store.existsById(A1.getStoreID())).thenReturn(true);
        Mockito.when( store.findById(A1.getStoreID())).thenReturn(java.util.Optional.ofNullable(s));

        assertEquals(service.UndoAction2(model, A1,request), "storeOwner_page");
    ...
    public void testUndoAction2_Edit() throws Exception {
        ...
        assertEquals(service.UndoAction2(model, action,request), "storeOwner_page");
