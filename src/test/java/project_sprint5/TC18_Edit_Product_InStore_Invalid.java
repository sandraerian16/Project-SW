...
public class TC18_Edit_Product_InStore_Invalid
{
    ...
    public void Edit_Product()
    {
        ...
        driver.findElement(By.cssSelector("body:nth-child(2) form:nth-child(1) p:nth-child(2) > input:nth-child(2)")).sendKeys("Clothes");
        driver.findElement(By.cssSelector("body:nth-child(2) form:nth-child(1) p:nth-child(3) > input:nth-child(2)")).sendKeys("660");
